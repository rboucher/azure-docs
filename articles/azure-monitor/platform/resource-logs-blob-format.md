---
title: Azure Monitor resource logs change to json format in append blobs
...
ms.subservice: logs
---
# Azure Monitor resource logs change to json format in append blobs archived to a storage account
